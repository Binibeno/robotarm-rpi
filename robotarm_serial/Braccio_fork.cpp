 ...
 *
 * NOTE: The soft start parameter does not work, and I could not find anyone on forums who could get it to work
         From others I found that it might set the fuses for the first 8 seconds in a different way
 */
unsigned int _Braccio::begin(int soft_start_level) {
  ...
  /* default - quite dangerous and can more easily lead to accidents
  step_base = 0;
  step_shoulder = 40;
  step_elbow = 180;
  step_wrist_ver = 170;
